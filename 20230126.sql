...
--
-- Table structure for table `loai_tai_nguyen`
--

DROP TABLE IF EXISTS `loai_tai_nguyen`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `loai_tai_nguyen` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL,
  `thu_phi` int NOT NULL,
  `la_cong_trinh` int NOT NULL DEFAULT '0',
  `xuat_xu` varchar(64) DEFAULT NULL,
  `mo_ta` text,
  `ghi_chu` text,
  `thu_phi_coc` int NOT NULL,
...
--
-- Dumping data for table `loai_tai_nguyen`
--

LOCK TABLES `loai_tai_nguyen` WRITE;
/*!40000 ALTER TABLE `loai_tai_nguyen` DISABLE KEYS */;
INSERT INTO `loai_tai_nguyen` VALUES (1,'nhan van hoa',200,1,'string','string','string',100,10000);
/*!40000 ALTER TABLE `loai_tai_nguyen` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `phien_su_dung`
--

DROP TABLE IF EXISTS `phien_su_dung`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `phien_su_dung` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tai_nguyen_id` int NOT NULL,
  `mo_ta` text,
  `ngay_muon` datetime NOT NULL,
  `ngay_hen_tra` datetime NOT NULL,
  `ngay_tra` datetime DEFAULT NULL,
  `phieu_muon` int DEFAULT NULL,
  `ghi_chu` text,
  PRIMARY KEY (`id`),
  KEY `tai_nguyen_FK` (`tai_nguyen_id`),
  KEY `phieu_muon_idx` (`phieu_muon`),
  KEY `ngay_muon_idx` (`ngay_muon`) USING BTREE,
  KEY ` ngay_tra_idx` (`ngay_hen_tra`) USING BTREE,
  CONSTRAINT `phieu_muon` FOREIGN KEY (`phieu_muon`) REFERENCES `phieu_muon` (`id`),
  CONSTRAINT `tai_nguyen_FK` FOREIGN KEY (`tai_nguyen_id`) REFERENCES `tai_nguyen` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `phien_su_dung`
--

LOCK TABLES `phien_su_dung` WRITE;
/*!40000 ALTER TABLE `phien_su_dung` DISABLE KEYS */;
INSERT INTO `phien_su_dung` VALUES (1,2,'{\"moi\":{\"mo_ta\":\"xuoc_dam\",\"tinh_trang\":8}}','2023-01-26 18:30:00','2023-01-28 18:30:00','2023-02-10 00:00:00',2,'string');
/*!40000 ALTER TABLE `phien_su_dung` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `phieu_muon` (
  `id` int NOT NULL AUTO_INCREMENT,
  `cccd` decimal(12,0) NOT NULL,
  `ho_va_ten` text NOT NULL,
  `so_dien_thoai` decimal(12,0) NOT NULL,
  `email` varchar(256) DEFAULT NULL,
  `user_tao` int NOT NULL,
  `user_phe_duyet` int DEFAULT NULL,
  `ngay_phe_duyet` datetime DEFAULT NULL,
  `ly_do` text NOT NULL,
  `trang_thai` varchar(16) DEFAULT NULL,
  `sao_ke_dang_ki` int NOT NULL,
  `sao_ke_tra` int DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `phieu_muon` VALUES (2,123456789,'test phieu muon',12345678,'minhtuan@gmaul.com',1,NULL,NULL,'cuoi','DONE',3,11);
/*!40000 ALTER TABLE `phieu_muon` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sao_ke`
--

DROP TABLE IF EXISTS `sao_ke`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sao_ke` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tien_thu` int NOT NULL,
  `tien_tra` int NOT NULL,
  `tien_thoi` int NOT NULL,
  `user_thu` int DEFAULT NULL,
  `ngay_gio` date NOT NULL DEFAULT (curdate()),
  `ghi_chu` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_thu_idx` (`user_thu`) USING BTREE,
  KEY `ngay_gio` (`ngay_gio`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sao_ke`
--

LOCK TABLES `sao_ke` WRITE;
/*!40000 ALTER TABLE `sao_ke` DISABLE KEYS */;
INSERT INTO `sao_ke` VALUES (3,100,200,100,1,'2023-01-26',NULL),(5,100,200,100,1,'2023-01-26',NULL),(11,100,200,100,1,'2023-01-26',NULL);
/*!40000 ALTER TABLE `sao_ke` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `tai_nguyen`
--

DROP TABLE IF EXISTS `tai_nguyen`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tai_nguyen` (
  ...
  `tinh_trang` int NOT NULL DEFAULT '10',
  `loai_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `loai_tai_nguyen_idx` (`loai_id`),
  KEY `loai_id_b_tree` (`loai_id`) USING BTREE,
  CONSTRAINT `loai_tai_nguyen` FOREIGN KEY (`loai_id`) REFERENCES `loai_tai_nguyen` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tai_nguyen`
--

LOCK TABLES `tai_nguyen` WRITE;
/*!40000 ALTER TABLE `tai_nguyen` DISABLE KEYS */;
INSERT INTO `tai_nguyen` VALUES (1,'string','string','2023-01-25',10,1),(2,'xuoc_dam','string','2023-01-25',8,1);
/*!40000 ALTER TABLE `tai_nguyen` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-26 15:12:04
